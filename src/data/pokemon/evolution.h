const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_TRADE, ITEM_KINGS_ROCK, SPECIES_POLITOED},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_TRADE, ITEM_KINGS_ROCK, SPECIES_SLOWKING},
    ...
    [SPECIES_ONIX]       = {{EVO_TRADE, ITEM_METAL_COAT, SPECIES_STEELIX},
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
    ...
    [SPECIES_SCYTHER]    = {{EVO_TRADE, ITEM_METAL_COAT, SPECIES_SCIZOR},
    ...
    [SPECIES_PORYGON]    = {{EVO_TRADE, ITEM_UP_GRADE, SPECIES_PORYGON2},
    ...
    [SPECIES_SKITTY]     = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_DELCATTY},
                            {EVO_FRIENDSHIP, 0, SPECIES_DELCATTY}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_BEAUTY, 170, SPECIES_MILOTIC},
                            {EVO_ITEM, ITEM_BLUE_SCARF, SPECIES_MILOTIC}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                            {EVO_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                            {EVO_TRADE, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS},
