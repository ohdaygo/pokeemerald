...
static const u8 sCompoundEyesDescription[] = _("Accuracy {UP_ARROW} 1.3x.");
...
static const u8 sFlashFireDescription[] = _("{FONT_NARROW}FIRE {UP_ARROW} 1.5x after hit by FIRE.");
static const u8 sShieldDustDescription[] = _("{FONT_NARROW}Prevents secondary effects.");
...
static const u8 sIntimidateDescription[] = _("{FONT_NARROW}Foe's ATTACK -1 on entry.");
...
static const u8 sWonderGuardDescription[] = _("{FONT_NARROW}Indirect & Super-effect. hits.");
...
static const u8 sHustleDescription[] = _("{FONT_NARROW}ATTACK {UP_ARROW} 1.5x, and Accuracy {DOWN_ARROW} 0.8x.");
static const u8 sCuteCharmDescription[] = _("{FONT_NARROW}1/3 Infat. odds when contacted.");
static const u8 sPlusDescription[] = _("{FONT_NARROW}SP. ATK {UP_ARROW} 1.5x if ally has MINUS.");
static const u8 sMinusDescription[] = _("{FONT_NARROW}SP. ATK {UP_ARROW} 1.5x if ally has PLUS.");
...
static const u8 sLiquidOozeDescription[] = _("{FONT_NARROW}Damages foe using draining move.");
static const u8 sOvergrowDescription[] = _("{FONT_NARROW}GRASS moves {UP_ARROW} 1.5x at 1/3 HP.");
static const u8 sBlazeDescription[] = _("{FONT_NARROW}FIRE moves {UP_ARROW} 1.5x at 1/3 HP.");
static const u8 sTorrentDescription[] = _("{FONT_NARROW}WATER moves {UP_ARROW} 1.5x at 1/3 HP.");
static const u8 sSwarmDescription[] = _("{FONT_NARROW}BUG moves {UP_ARROW} 1.5x at 1/3 HP.");
