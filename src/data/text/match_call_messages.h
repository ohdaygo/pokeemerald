...
const u8 gText_MatchCallSootopolitan_Wallace_Strategy[] = _("With dignity and respect.");
const u8 gText_MatchCallSootopolitan_Wallace_Pokemon[] = _("I prefer POKéMON of grace.");
const u8 gText_MatchCallSootopolitan_Wallace_Intro1[] = _("I represent beauty as");
const u8 gText_MatchCallSootopolitan_Wallace_Intro2[] = _("well as intelligence.");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_WALLACE_GYM] = MCFLAVOR(Sootopolitan_Wallace),
