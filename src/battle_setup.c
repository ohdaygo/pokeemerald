...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_WALLACE_GYM] = REMATCH(TRAINER_WALLACE_1, TRAINER_WALLACE_2, TRAINER_WALLACE_3, TRAINER_WALLACE_4, TRAINER_WALLACE_5, MAP_SOOTOPOLIS_CITY),
    ...
    [REMATCH_STEVEN_CHAMP] = REMATCH(TRAINER_STEVEN_CHAMP, TRAINER_STEVEN_CHAMP, TRAINER_STEVEN_CHAMP, TRAINER_STEVEN_CHAMP, TRAINER_STEVEN_CHAMP, MAP_EVER_GRANDE_CITY),
};
...
static void TryUpdateGymLeaderRematchFromTrainer(void)
{
    if (GetGameStat(GAME_STAT_TRAINER_BATTLES) % 3 == 0)
        UpdateGymLeaderRematch();
}
