...
extern const u8 gText_XNatureObtainedOrre[];
...
extern const u8 gTrickHouse_Mechadoll_300Yen[];
extern const u8 gTrickHouse_Mechadoll_CantAfford[];
...
extern const u8 MatchCall_Text_WallaceGym_Preparing[];
extern const u8 MatchCall_Text_WallaceGym_PreparingPostGame[];
extern const u8 MatchCall_Text_WallaceGym_RematchReady[];
extern const u8 MatchCall_Text_WallaceGym_PostRematch[];
...
extern const u8 gText_WallaceGymMatchCallDesc[];
